...
public final class ABiggerEqExpression extends PExpression
{
    private PExpression _l_;
    private PExpression _r_;

    public ABiggerEqExpression()
    {
    }
    ...
    public Object clone()
    {
        return new ABiggerEqExpression(
    ...
    {
        ((Analysis) sw).caseABiggerEqExpression(this);
    }
