...
public final class ASmallerExpression extends PExpression
{
    private PExpression _l_;
    private PExpression _r_;

    public ASmallerExpression()
    {
    }
    ...
    {
        ((Analysis) sw).caseASmallerExpression(this);
    }
