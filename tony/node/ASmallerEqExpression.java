...
public final class ASmallerEqExpression extends PExpression
{
    private PExpression _l_;
    private PExpression _r_;

    public ASmallerEqExpression()
    {
    }
    ...
    public Object clone()
    {
        return new ASmallerEqExpression(
    ...
    {
        ((Analysis) sw).caseASmallerEqExpression(this);
    }
