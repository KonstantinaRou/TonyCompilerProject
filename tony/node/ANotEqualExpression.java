...
public final class ANotEqualExpression extends PExpression
{
    private PExpression _l_;
    private PExpression _r_;

    public ANotEqualExpression()
    {
    }
    ...
    public Object clone()
    {
        return new ANotEqualExpression(
    ...
    {
        ((Analysis) sw).caseANotEqualExpression(this);
    }
