...
public final class ASignnumberExpression extends PExpression
{
    private PExpression _l_;
    private PExpression _r_;

    public ASignnumberExpression()
    {
    }
    ...
    public Object clone()
    {
        return new ASignnumberExpression(
    ...
    {
        ((Analysis) sw).caseASignnumberExpression(this);
    }
